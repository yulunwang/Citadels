...
Each round, players secretly draft one of 8 characters. Characters are called in order; when yours is called, you act.
...
Purple districts have special abilities — the Smithy lets you spend gold to draw cards, the Great Wall raises Warlord costs, the School of Magic counts as any color, and more.
...
2. **Turns** — the Herald calls characters 1–8 in order; each holder takes their turn:
